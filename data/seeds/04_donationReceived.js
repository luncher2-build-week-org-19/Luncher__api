    ...
    return knex("donationsReceived")
        ...
        .then(function() {
            ...
            return knex("donationsReceived").insert([
                ...
                { amount: 10.25, userId: 3, donationId: 0 },
                { amount: 20, userId: 2, donationId: 2 },
                { amount: 15, userId: 0, donationId: 2 },
                { amount: 17.86, userId: 0, donationId: 0 },
                { amount: 5.6, userId: 2, donationId: 0 },
                { amount: 35.7, userId: 3, donationId: 1 },
                { amount: 22.25, userId: 1, donationId: 2 },
                { amount: 99, userId: 1, donationId: 0 },
                { amount: 13.89, userId: 3, donationId: 3 },
                { amount: 75, userId: 2, donationId: 3 },
                { amount: 23.22, userId: 0, donationId: 0 },
                { amount: 55, userId: 0, donationId: 0 },
